Ext.define('TPGLXT.controller.yonghuGL', {
	extend : 'Ext.app.Controller',
	stores : ['yonghuGL'],
	views : ['yonghuGL', 'register'],
	onButtonClick : function(button, e, eOpts) {
		if (button.text == '添加') {
			...
			rylxcombo.hide();
			win.down('button[text=保存]').setHandler(function(but) {
